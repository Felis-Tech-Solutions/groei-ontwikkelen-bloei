  ...
  <div class="mx-auto grid max-w-7xl grid-cols-1 gap-10 px-6 lg:grid-cols-12 lg:gap-8 lg:px-8">
    ...
    <form class="w-full lg:col-span-5 lg:pt-2">
      <div class="flex flex-col gap-y-4 w-full"> <!-- Use flex-col for vertical stacking -->
        ...
        <button type="submit" class="rounded-md bg-indigo-600 px-3.5 py-2.5 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">Ik neem contact op</button>
      </div>
      <p class="mt-4 text-sm leading-6 text-gray-900">We geven om je data, lees onze <a href="#" class="font-semibold text-indigo-600 hover:text-indigo-500">privacy policy</a>.</p>
    </form>
  </div>
</div>
<!-- footer content -->
